        ...
        <div class="my-auto w-full">
          <div class="flex flex-col">
            <div class="text-4xl font-poppins text-gray-800">
              ...
              <span class="font-semibold">Wan Pzee's Page</span>
              <span class="text-6xl text-lead-yellow">.</span>
            </div>
            <div class="font-thin font-sans test-grey-700 text-left -mt-4">
              Found of Grud Tech | Instructor @ LEAD | Data Scientist |
              Fullstack Developer
            </div>
          </div>
        </div>
